...
function Header() {
  ...
  return (
    ...
    M789.6,41.6l14.2-14.9H822l-20.2,14.9H789.6z"/>
              <path className='two' d="M2.3,159.4l149-0.9c0.6,0,1-0.3,1.2-0.9l41.9-109c0.5-1.2-0.8-2.3-1.9-1.6L1.6,156.9C0.4,157.6,0.9,159.5,2.3,159.4z"/>
              <circle class="st0" cx="132.9" cy="41.2" r="38.1"/ >
              <path className='one' d="M98.9,22.7C76.2,25.9,76.4,26.5,67,41.9c-4.4,7.8,0.6,23.2-3.9,30.5c-10,6.9-12.1,28.7-19.3,37.5
